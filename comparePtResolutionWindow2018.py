...
def compareMassRes(trackType):
	...
	fileDefaultBB = open("2018Boosteddefault/MassResolutionVsPt_%s_BB.pkl"%trackType,'rb')
	fileORBB = open("2018BoostedWindowLarge/MassResolutionVsPt_%s_BB.pkl"%trackType,'rb')
	fileNoBB = open("2018BoostedWindowSmall/MassResolutionVsPt_%s_BB.pkl"%trackType,'rb')
	fileDefaultBE = open("2018Boosteddefault/MassResolutionVsPt_%s_BE.pkl"%trackType,'rb')
	fileORBE = open("2018BoostedWindowLarge/MassResolutionVsPt_%s_BE.pkl"%trackType,'rb')
	fileNoBE = open("2018BoostedWindowSmall/MassResolutionVsPt_%s_BE.pkl"%trackType,'rb')
	...
	canv.Print("massResolutionVsPtWindow2018_%s_BB.pdf"%trackType)
	...
	canv.Print("massResolutionVsPtWindow2018_%s_BE.pdf"%trackType)
