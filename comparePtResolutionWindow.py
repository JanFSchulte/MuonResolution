...
def compareMassRes(trackType, year):
	...
	fileORBB = open("%sBoostedWindowLargeLeading/MassResolutionVsPt_%s_Barrel.pkl"%(year,trackType),"rb")
	fileNoBB = open("%sBoostedWindowSmallLeading/MassResolutionVsPt_%s_Barrel.pkl"%(year,trackType),"rb")
	fileDefaultBE = open("%sBoosteddefaultLeading/MassResolutionVsPt_%s_OverlapEndcap.pkl"%(year,trackType),"rb")
	fileORBE = open("%sBoostedWindowLargeLeading/MassResolutionVsPt_%s_OverlapEndcap.pkl"%(year,trackType),"rb")
	fileNoBE = open("%sBoostedWindowSmallLeading/MassResolutionVsPt_%s_OverlapEndcap.pkl"%(year,trackType),"rb")
	...
	canv.Print("massResolutionVsPtWindow_%s_%s_Central.pdf"%(trackType,year))
	...
	leg = TLegend(0.52, 0.76, 0.95, 0.91,"%s %s Forwared"%(trackType, year),"brNDC")
	leg.SetFillColor(10)
	leg.SetFillStyle(0)
	leg.SetLineColor(10)
	leg.SetShadowColor(0)
	...
	canv.Print("massResolutionVsPtWindow_%s_%s_Forward.pdf"%(trackType,year))
