...
def compareMassRes(trackType):
	...
	fileORBB = open("2018Boosteddefault/MassResolutionVsPt_%s_BB.pkl"%trackType,"rb")
	fileNoBB = open("2018Boostedcruijff/MassResolutionVsPt_%s_BB.pkl"%trackType,"rb")
	fileDefaultBE = open("2018BoosteddefaultGT36/MassResolutionVsPt_%s_BE.pkl"%trackType,"rb")
	fileORBE = open("2018Boosteddefault/MassResolutionVsPt_%s_BE.pkl"%trackType,"rb")
	fileNoBE = open("2018Boostedcruijff/MassResolutionVsPt_%s_BE.pkl"%trackType,"rb")
	...
	leg.SetBorderSize(1)		
	leg.AddEntry(graphDefaultBB,"GT36 Dataset","l")
	leg.AddEntry(graphORBB,"Old Dataset","l")
	...
	canv.Print("massResolutionGT36_%s_BB.pdf"%trackType)
	...
	leg.SetShadowColor(0)
	leg.SetBorderSize(1)		
	leg.AddEntry(graphDefaultBE,"GT36 Dataset","l")
	leg.AddEntry(graphORBE,"Old Dataset","l")
	...
	canv.Print("massResolutionGT36_%s_BE.pdf"%trackType)
