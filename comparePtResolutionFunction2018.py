...
def compareMassRes(trackType):
	...
	fileORBB = open("2018Boostedcrystal/MassResolutionVsPt_%s_BB.pkl"%trackType,"rb")
	...
	fileORBE = open("2018Boostedcrystal/MassResolutionVsPt_%s_BE.pkl"%trackType,"rb")
	...
	canv.Print("massResolutionFunc2018_%s_BB.pdf"%trackType)
	...
	canv.Print("massResolutionFunc2018_%s_BE.pdf"%trackType)
